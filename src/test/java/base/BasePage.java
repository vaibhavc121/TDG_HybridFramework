...
public class BasePage
{
    ...
    */
    ...
    public static void selectOption1(By shadowHost, By elementLocator)
    {
    ...
    public static void selectOption2(By shadowHost0, By shadowHost1, By elementLocator)
    {
...
//		clickElementByJavaScript(DriverFactory.getDriver(), element);
    ...
    public static boolean validateListingEy(String expectedValue)
    {
        String result = waitForElement1(By.xpath("(//div[@class='ag-cell-value ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-column-first']//span)[1]")).getText();
